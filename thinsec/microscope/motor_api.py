...
class BaseMotorLink(object):
    ...
    def __init__(self):
        ...
        self.indexed_ids = { cfg['index']: axis for axis, cfg
                             in config_base.items() }
    ...
    def move_command(self, motor, kind, value=1, acceleration=100, max_speed=800,
                     backlash=0):
        ...
        if kind == 'abs':
            self.move_absolute(motor, value)
        elif kind == 'rel':
            self.move_relative(motor, value)
